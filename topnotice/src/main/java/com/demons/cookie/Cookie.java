...
import com.liuguangqiang.cookie.R;
...
final class Cookie extends LinearLayout {
    ...
    public void setParams(final CookieBar.Params params) {
        if (params != null) {
            ...
            //Background
            if (params.cookieBarHeight != 0) {
                LinearLayout.LayoutParams linearParams = (LinearLayout.LayoutParams) layoutCookie.getLayoutParams();
                linearParams.height = params.cookieBarHeight;
                layoutCookie.setLayoutParams(linearParams);
            }
            //Background
